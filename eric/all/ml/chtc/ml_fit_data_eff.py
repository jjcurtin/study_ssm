...
if run_CHTC:
    ...
    #subid = 5
    key = 'rs1fold0'
    with open('/Users/eric/repos/aud/ml/chtc/ml_fold_reference.json') as f:
        fold_reference = json.load(f)
    raw_feats_labels = pd.read_csv("/Users/eric/repos/aud/data/ml_labels_full_width.csv")
    test_feats_labels = pd.read_csv("/Users/eric/repos/aud/data/ml_labels_limited_width.csv")
...
xgb_hyperparameter_grid = {'n_estimators':[25,50,75,100,125,150,175,200,225,250,275,300,325,350,375,400],'eta':[0.1], 'colsample_bytree':[.75], 'subsample':[0.5],
          'max_depth':[1,2,3,4,5],'min_child_weight':[1,2,3,4,5]}
