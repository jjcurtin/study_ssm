...
# Select either auc or aucpr
all_auc_vals <- read.csv("ml/chtc/data_eff_auc_summary.csv")
export_path <- 'post_exports.csv'
# all_auc_vals <- read.csv("ml/chtc/data_eff_aucpr_summary.csv")
# export_path <- 'post_exports_aucpr.csv'
